    ...
    <Container fluid id="about">
        <Row className='about-row'>
            ...
            <h3 className="heading">About me...</h3>
                ...
                <p>Few things not mentioned in my resume. I love trekking and want to cover as many mountain treks as possible. I admit I have a weak spot for chole bhature and if we ever go out, chances are I'll order chole bhature, momos and noodles for the table. Consistency is my strength. Have been trying to maintain a balance between fitness and love for food and I am consistently failing at it. Finally, I am sure you will never be bored in my company.</p>
