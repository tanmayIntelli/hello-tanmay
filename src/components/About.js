    ...
    <Container fluid id="about">
        <Row className='about-row'>
            ...
            <h3 className="heading">About me...</h3>
                <p>Hey there. I'm Tanmay (Yes, that's my full name), a 24 year old software engineer with special interest in Web developement. I currently live in <a className="content-link" href="https://goo.gl/maps/8N5KRaFdZzAtgsYS9" rel="nofollow" target="_blank">New Delhi</a>, India but owing to my parents’ air force life, much of my life has been spent in ‘Bharat Darshan’. I am fairly confident about my cooking and coding skills. Professionally a Computer Science Engineer, currently trying to make healhcare accessible for all by continuous innovtion, with awesome folks at <a className="content-link" href="https://www.cerner.com/">Cerner Corporation</a>.</p>
